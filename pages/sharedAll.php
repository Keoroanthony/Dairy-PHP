        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                    ...
                    <?php 
                       $result = mysqli_query($con,"SELECT * FROM `articles` WHERE admin = 1 ORDER BY `articles`.`date` DESC") or die('Error');
                       ...
                       while($row = mysqli_fetch_array($result)) {
                           ...
                           $share = $row['share'];
                           if($share==1){ 
                               echo '<td><a title="Click to open article" href="viewarticles.php?aid='.$id.'">'.$title.'</a></td><td>'.$date.'</td><td>'.$time.'</td>
                           <td><a title="Open Article" href="viewarticles.php?aid='.$id.'"><b><i class="fa fa-file-text" aria-hidden="true"></i></b></a></td>';
                           echo '<td><a title="Get printable view" target="_blank" href="update.php?pid='.$id.'"><b><i class="fa fa-print" aria-hidden="true"></i></b></a></td>
                           </tr>';
                       }}
                       echo '</table></div>';
