            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h6 class="font-weight-normal mb-0">Shared content goes here</h6>
                </div>
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <?php 
                 ...
                 <tr><td><b>Title</b></td><td><b>Date</b></td><td><b>Time</b></td><td></td><td></td><td></td></tr>';
                 while($row = mysqli_fetch_array($result)) {
                     ...
                     if($share==1){
                      echo '<tr><td><a title="Click to open article" href="viewarticles.php?aid='.$id.'">'.$title.'</a></td><td>'.$date.'</td><td>'.$time.'</td>
                  <td><a title="Open Article" href="viewarticles.php?aid='.$id.'"><b><i class="fa fa-file-text" aria-hidden="true"></i></b></a></td>';
                  if($admin==0)echo '<td><a title="not shared" href="update.php?add='.$id.'"><b><i class="fa fa-check" aria-hidden="true"></i></b></a></td>';
                     else echo '<td><a title="shared" href="update.php?add='.$id.'"><b><i class="fa fa-check" aria-hidden="true" style="color:orange"></i></b></a></td>';
                     echo '<td><a title="Get printable view" target="_blank" href="update.php?pid='.$id.'"><b><i class="fa fa-print" aria-hidden="true"></i></b></a></td></tr>';
                 }}
                 echo '</table></div>';
